...
function Products(){
    ...
    <NavLink to={`/products/${productsdata.id}`}><div onMouseEnter={()=>{handleHover(productsdata.id)}} onMouseLeave={()=>handleHover(null)}><img className="product-img" src={hover ===productsdata.id ? productsdata.hoverimg:productsdata.Image}/></div></NavLink>
